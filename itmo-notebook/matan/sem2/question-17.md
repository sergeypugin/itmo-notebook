---
title: "Несобственные интегралы второго рода"
author: "Dimas"
links:
...
## Определение. Понятия несобственного интеграла 2 рода

**Несобственный интеграл второго рода** - это несобственный интеграл от неограниченной функции по промежутку конечной длины
$$
...
Для доказательства достаточно перейти к пределу при $\omega \to b-0$ в равенстве, [свойствами интеграла](question-9) для интеграла Римана:
$$
...
Для доказательства достаточно перейти к пределу при $\omega \to b-0$ в равенстве, [свойствами интеграла](question-9):
$$
...
Для доказательства достаточно перейти к пределу при $\omega \to b-0$ в неравенстве, [свойствами интеграла](question-9):
$$
...
Согласно [понятие несобственного интеграла и его свойства](question-9), сходимость интеграла равносильна существованию предела функции $F(\omega)$ при $\omega \to b-0$. Согласно критерию Коши существования предела функции, это выполнено тогда и только тогда, когда
$$
...
Последнее же неравенство, в силу [свойств интеграла](question-9), переписывается как
$$
...
Ясно, что если $a \leq \omega_1 \leq \omega_2 < b$, то, так как $f \geq 0$, по [свойствам интеграла](question-9) интеграла Римана,
$$
